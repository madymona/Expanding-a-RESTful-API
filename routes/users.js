...
router.get("/:id/comments/post/:postId", (req, res) => {
  const userCommentsOnPost = comments.filter(
    comment => comment.userId == req.params.id && comment.postId == req.params.postId
  );
